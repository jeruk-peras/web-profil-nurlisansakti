    ...
    <body>
                           ...
                           <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-lg-7 col-md-7">
                                    <div class="slider-content s-slider-content mt-20">
                                         <h5 data-animation="fadeInUp" data-delay=".4s">welcome To Autozox</h5>
                                        ...
                                        <p data-animation="fadeInUp" data-delay=".6s">Donec vitae libero non enim placerat eleifend aliquam erat volutpat. Curabitur diam ex, dapibus purus sapien, cursus sed nisl tristique, commodo gravida lectus non.</p>
                                          ...
                                          <div class="slider-btn mt-30 mb-105">     
                                            <a href="contact.html" class="btn ss-btn mr-15" data-animation="fadeInLeft" data-delay=".4s">Discover More <i class="fal fa-angle-right"></i></a>
       ...
       <div class="col-lg-6 col-md-6">
           ...
           <!-- services-three-area -->
            ...
            <section id="service-details2" class="pt-120 pb-105 p-relative" style="background: url(img/bg/services-bg.html); background-size: contain; background-position: center center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <div class="footer-widget mb-30">
                                ...
                                <p>Subscribe our newsletter to get our latest update & News</p>
                                 <div class="subricbe p-relative" data-animation="fadeInDown" data-delay=".4s" >
                                            <form action="https://htmldemo.zcubethemes.com/autozox/news-mail.php" method="post" class="contact-form ">
            ...
            <div class="copyright-wrap">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                          <div class="copy-text">
                                 Copyright &copy; Autozox 2022 . All rights reserved.       
                            </div>
                        </div>
