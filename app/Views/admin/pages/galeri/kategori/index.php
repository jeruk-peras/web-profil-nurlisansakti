...
<div class="page-content">
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-2">
        <div class="breadcrumb-title pe-3">Kategori Galeri</div>
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>"><i class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Daftar Kategori Galeri</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card radius-10">
        <div class="card-header border-0 bg-transparent">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">Daftar Kategori Galeri</h6>
                </div>
                <div class="ms-auto">
            ...
            <form action="" method="post" id="form-data">
                ...
                <div class="modal-body">
                    <div class="row g-3" id="form-menu">
                        <div class="col-md-12">
                            <label for="kategori" class="form-label fw-medium required">Kategori</label>
...
<?= $this->include('admin/pages/galeri/kategori/script'); ?>
<?= $this->endSection(); ?>