        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2">
                    ...
                    <div>
                        <a href="/adm/galeri/<?= $row['id']; ?>/publish" class="me-2 badge <?= $row['publish'] ? 'bg-primary' : 'bg-warning'; ?> btn-publish" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?= $row['publish'] ? 'hide' : 'Publish'; ?>"><?= $row['publish'] ? 'publish' : 'hide'; ?></a>
                    </div>
                </div>
            </div>
        </div>
