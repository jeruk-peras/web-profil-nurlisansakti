        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item">Daftar Halaman</li>
                    <li class="breadcrumb-item active" aria-current="page">Form Halaman</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <a href="/adm/halaman/" class="btn btn-sm btn-primary"><i class="bx bx-arrow-back"></i> Kembali</a>
        </div>
    </div>
    ...
    <div class="card radius-10">
        <div class="card-body">
            <form action="" method="post" id="form-data" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="judul_halaman" class="form-label fw-medium required">Judul Halaman</label>
                        <input type="text" name="judul_halaman" id="judul_halaman" class="form-control" value="<?= $data['judul_halaman'] ?? ''; ?>">
                        <div class="invalid-feedback" id="invalid_judul_halaman"></div>
                    </div>
                    <div class="col-md-12">
    ...
    $('#form-data').submit(async function(e) {
        ...
        $.ajax({
            ...
            success: async function(response) {
                ...
                window.location.href = '/adm/halaman';
            },
