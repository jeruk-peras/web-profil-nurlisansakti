        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Form Artikel</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <a href="/adm/artikel/" class="btn btn-sm btn-primary"><i class="bx bx-arrow-back"></i> Kembali</a>
        </div>
    </div>
    ...
    <div class="card radius-10">
        <div class="card-body">
            <form action="" method="post" id="form-data" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="judul_artikel" class="form-label fw-medium required">Judul Artikel</label>
                        <input type="text" name="judul_artikel" id="judul_artikel" class="form-control" value="<?= $data['judul_artikel'] ?? ''; ?>">
                        <div class="invalid-feedback" id="invalid_judul_artikel"></div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="invalid-feedback" id="invalid_penulis"></div>
                    </div>
                    <div class="col-md-6">
                        <label for="tanggal" class="form-label fw-medium required">Tanggal</label>
                        <input type="date" name="tanggal" id="tanggal" class="form-control" value="<?= $data['tanggal'] ?? date('Y-m-d'); ?>">
